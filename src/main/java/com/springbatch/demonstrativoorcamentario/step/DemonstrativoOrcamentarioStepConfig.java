...
import com.springbatch.demonstrativoorcamentario.writer.DemostrativoOrçamentarioRodape;
...
public class DemonstrativoOrcamentarioStepConfig {
	...
	public Step demonstrativoOrcamentarioStep(
			...
			DemostrativoOrçamentarioRodape demostrativoOrçamentarioRodape) {
		return stepBuilderFactory
				...
				.listener(demostrativoOrçamentarioRodape)
				.build();
	}
}
